...
namespace NV1Sim
{
    ...
    uint8_t Util_Gray2Binary(uint32_t gray)
    {
        return nv1_pfifo_cache1_binary_code_table[gray];
    }

    uint8_t Util_Binary2Gray(uint32_t binary)
    {
        return nv1_pfifo_cache1_gray_code_table[binary];
    }
}